/* thinking-orbs 0.3.2 engine (https://libraries.dev/orbs), MIT License, Copyright (c) 2026 Jakub Antalik.
   The framework-free engine from the npm package, wrapped as a classic script so it runs from file:// too.
   Exposes window.ThinkingOrbs = { MODE_FRAMES, MODE_DRAWS, STATE_TO_MODE, resolvePreset, paintFrame, scaleCounts, scaleRadii }. */
(function(){
function lerp(a, b, f) {
  return a + (b - a) * f;
}
...
window.ThinkingOrbs = { MODE_FRAMES: MODE_FRAMES, MODE_DRAWS: MODE_DRAWS, STATE_TO_MODE: STATE_TO_MODE, resolvePreset: resolvePreset, paintFrame: paintFrame, scaleCounts: scaleCounts, scaleRadii: scaleRadii };
})();
