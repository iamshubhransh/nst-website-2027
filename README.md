...
- Figma frame 153:23441, top to bottom: top bar, hero, quick summary (93% stat, stats grid, companies), companies orbit with the CTC card, campus internship card, swipeable internship-win cards, placement-auditor card (frame 234:18365: centred badge and titles, auditor logo marquee, two report cards with calendar icons). seven foundations (frame 234:36816: hanging lines with travelling pulses, a list of the seven buckets that steps up on a loop), open source culture (frame 267:51819: header and a placeholder card for now). A bottom bar with the play button and Apply Now (frame 153:32692) slides in once the hero has scrolled off the top and stays fixed.
