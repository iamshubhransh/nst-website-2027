...
- Achievement buckets, alternating dark and light: open source (frame 282:72461), competitive coding (282:80431), entrepreneurship (328:1959), global exposure (328:4384), research (328:9279). Every bucket shares a header (bar + title + line), 42/16 padding and a CTA. Between buckets "the thread": a dashed track runs through the two paddings and a brand-blue runner travels it as the seam passes mid-screen, then docks as the next header's bar, which draws in. Assets are under `assets/oss`, `cc`, `ent`, `glob`, `res`.
